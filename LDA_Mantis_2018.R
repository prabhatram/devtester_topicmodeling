...
mantis18ISS <- read.csv(file.choose(), header = T)
mantis18FB  <- read.csv(file.choose(), header = T)

mantis18ISS$issueDescription <- as.character(mantis18ISS$issueDescription)
mantis18FB$testFeedback <- as.character(mantis18FB$testFeedback)

issue_descend <- tibble(id = mantis18ISS$issueId, desc = mantis18ISS$issueDescription)
feedback_descend <- tibble(id = mantis18FB$issueId, feedback = mantis18FB$testFeedback)
